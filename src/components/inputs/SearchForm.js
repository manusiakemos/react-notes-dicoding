...
class SearchForm extends React.Component {
  constructor(props) {
    ...
    this.onKeywordsChangeEventHandler = this.onKeywordsChangeEventHandler.bind(this);
    this.onSubmitEventHandler = this.onSubmitEventHandler.bind(this);
  }

  onKeywordsChangeEventHandler(event) {
    ...
    return (
      <form id="searchForm" onSubmit={this.onSubmitEventHandler}>
        <input
          ...
          onChange={this.onKeywordsChangeEventHandler}
        />
